...
Windows alatt:   
    - Arduino ESP32 Core 3.3.7 esetén   
    C:\Users<FELHASZNÁLÓNÉV>\AppData\Local\Arduino15\packages\esp32\tools\esp32s3-libs\3.3.7\lib
...
⚠️ Fontos:
A javított libesp_netif.a és liblwip.a fájlok kifejezetten az Arduino ESP32 Core 3.3.7 verziójához készültek.
